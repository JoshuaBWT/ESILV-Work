     ...
     try
     {
      ...
      function(err, response, body) {
        ...
        if(err) {
          ...
          {
            resolveUrlIfProblem(url, body, parameters, function(nbody, nparameters, urls)
            {
                if(!nbody || !nparameters || !urls)
                  callback(null, null);
          ...
          else if(response.request.uri.href = "http://www.lacentrale.fr/lacote_origine.php")
          {
            callback(null,null);
          }
